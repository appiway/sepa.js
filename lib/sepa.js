...
(function(exports) {
  ...
  SepaTransaction.prototype = {
    ...
    validate: function() {
      ...
      var IBANcountry = this[pullFrom + 'IBAN'].substr(0, 2);
      var BICcountry = this[pullFrom + 'BIC'].substr(4, 2);
      // handle FR iso territories
      var parent_iso_codes = {
          'GP': 'FR',
          'GF': 'FR',
          'MQ': 'FR',
          'RE': 'FR',
      ...
      // TODO refactor
      var countryMatches = (this[pullFrom + 'BIC'].length === 0 || BICcountry === IBANcountry);
      if(!countryMatches && parent_iso_codes[BICcountry]){
        BICcountry = parent_iso_codes[BICcountry]
        countryMatches = (this[pullFrom + 'BIC'].length === 0 || BICcountry === IBANcountry);
      }
      assert(countryMatches, 'country mismatch in BIC/IBAN');
